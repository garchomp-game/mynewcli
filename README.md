...
running command...
$ mynewcli (--version)
mynewcli/0.0.0 linux-x64 node-v18.19.0
...
_See code: [src/commands/hello/index.ts](https://github.com/garchomp-game/mynewcli/blob/v0.0.0/src/commands/hello/index.ts)_
...
_See code: [src/commands/hello/world.ts](https://github.com/garchomp-game/mynewcli/blob/v0.0.0/src/commands/hello/world.ts)_
